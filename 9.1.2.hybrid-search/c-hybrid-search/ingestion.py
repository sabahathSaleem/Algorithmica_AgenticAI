...
async def setup_vector_database_and_ingest(pool):
    async with pool.acquire() as conn:
        ...
        await conn.execute("""
            ...
            CREATE TABLE IF NOT EXISTS documents3 (
            ...
            ON documents3 USING hnsw (embedding_vector vector_cosine_ops);
            
            CREATE INDEX IF NOT EXISTS idx_documents_search 
            ON documents3 USING GIN(search_vector);
        """)
        ...
        for file in dir.glob("*"):
            ...
            await conn.execute(
                "INSERT INTO documents3 (doc_name, doc_content, embedding_vector) VALUES ($1, $2, $3)", 
