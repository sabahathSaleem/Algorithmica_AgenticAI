...
if __name__ == "__main__":
    ...
    train_dataset = CustomDataset(base_dir / "non-linear1/train.csv")
    val_dataset = CustomDataset(base_dir / "non-linear1/test.csv")

    model = RegressionNetwork2(1, 10, 1)
    batch_size = 10
    epochs = 100

    train(model, epochs, batch_size, train_dataset, val_dataset)
    print(model.state_dict())
    torch.save(model, base_dir / "models/model2.pth")